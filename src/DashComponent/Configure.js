...
const configureSchema = () => Yup.object({
    ...
    UTR2: Yup.number().required("please enter upperTank shape parameter2").min(1,"enter value greater than equal to 1").max(2000,"enter value less than equal to 2000"),
    LTR1: Yup.number().required("please enter lowerTank shape parameter1").min(1,"enter value greater than equal to 1").max(2000,"enter value less than equal to 2000"),
    UTR1: Yup.number().required("please enter upperTank shape parameter1").min(1,"enter value greater than equal to 1").max(2000,"enter value les than equal to 2000"),
    LTR2: Yup.number().required("please enter lowerTank shape parameter2").min(1,"enter value greater than equal to 1").max(2000,"enter value less than equal to 2000"),
